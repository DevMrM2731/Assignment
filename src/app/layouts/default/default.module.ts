...
import { CreateexamComponent } from 'src/app/modules/exam/quizexam/createexam/createexam.component';
...
@NgModule({
  declarations: [DefaultComponent,ComingsoonComponent,CreateexamComponent,DraftexamComponent,MyexamsComponent,ScheduleexamComponent,DashboardComponent],
  imports: [
    CommonModule,
    RouterModule,
    SharedModule,
