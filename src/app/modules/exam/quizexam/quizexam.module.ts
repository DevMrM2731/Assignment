...
import { DraftexamComponent } from './draftexam/draftexam.component';
...
@NgModule({
  declarations: [CreateexamComponent, DraftexamComponent, MyexamsComponent, ScheduleexamComponent],
  imports: [
    CommonModule
  ]
})
